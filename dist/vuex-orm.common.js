...
var Builder = /** @class */ (function () {
    ...
    Builder.build = function (data, Query) {
        ...
        return Utils.mapValues(data, function (records, entity) {
            ...
            return Utils.mapValues(records, function (record) {
                return __assign$8({}, _this.buildFields(record, model.fields()), { $id: record.$id });
            });
        });
    };
    /**
    ...
    Builder.buildFields = function (record, fields) {
        var _this = this;
        return Utils.mapValues(fields, function (field, key) {
            if (field instanceof Attribute) {
...
var Data = /** @class */ (function () {
     ...
     */
    Data.fillAll = function (data, query) {
...
var Persist = /** @class */ (function () {
    ...
    Persist.prototype.saveEach = function () {
        ...
        Utils.forOwn(this.data, function (records, entity) {
            ...
            var filledRecords = _this.query.getModel(entity).hydrateMany(records, ['$id']);
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.insertOrUpdate = function (data, create) {
        ...
        var updatedItems = [];
        var persistedItems = [];
        Utils.forOwn(normalizedData, function (records, entity) {
    ...
    Query.prototype.processUpdateByCondition = function (data, condition) {
        ...
        var items = records.map(function (record) { return _this.model.id(record); });
    ...
    Query.prototype.delete = function (condition) {
        if (typeof condition === 'function') {
            this.state.data = Utils.pickBy(this.state.data, function (record) { return !condition(record); });
            return;
        }
        var id = typeof condition === 'number' ? condition.toString() : condition;
        this.state.data = Utils.pickBy(this.state.data, function (_record, key) { return key !== id; });
    };
    /**
     * Delete all records from the state.
     */
...
var Module = /** @class */ (function () {
    ...
    Module.createTree = function (tree, namespace, modules) {
        ...
        Object.keys(modules).forEach(function (name) {
            ...
            tree.modules[name] = {
                namespaced: true,
                state: __assign$11({}, module.state, _this.state, { $connection: namespace, $name: name })
            };
